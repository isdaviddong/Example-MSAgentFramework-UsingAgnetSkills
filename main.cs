...
// MAAI001: Microsoft.Agents.AI marks some APIs as experimental during stabilization.
// OPENAI001: OpenAI Responses APIs can be marked preview/experimental.
...
{
    Console.WriteLine("請先在 src/test.cs 中設定 openAIApiKey 再執行。");
    return;
}
